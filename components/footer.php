<!-- Footer Start -->
<footer class="w-full bg-[#0a0c10] text-[#a0a5b5] pt-20 pb-10 border-t border-gray-900 relative z-30 shadow-[0_-30px_70px_rgba(0,0,0,0.6)] overflow-hidden" id="global-footer">
    <!-- Subtle Grid overlay specific to Footer -->
    <div class="absolute inset-0 bg-grid-pattern opacity-5 pointer-events-none -z-10"></div>
    
    <!-- Huge background outline text for immersive branding -->
    <div class="absolute right-[-10%] bottom-[-5%] text-[10vw] font-black text-white/[0.01] select-none tracking-widest pointer-events-none uppercase -z-10">
        IT DEPT CVC
    </div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
            ...
            <div class="lg:col-span-3 flex flex-col space-y-6">
                ...
                <div class="flex flex-col space-y-4 text-sm">
                    ...
                    <div class="flex items-start space-x-3.5">
                        <div class="w-9 h-9 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center flex-shrink-0 text-primary-light">
                            <i class="fas fa-map-marker-alt"></i>
                        </div>
                        <div class="flex flex-col">
                            <span class="text-white font-medium text-xs">วิทยาลัยอาชีวศึกษาเชียงราย</span>
                            <span class="text-[#82889a] text-xs leading-relaxed mt-0.5">เลขที่ 670 ถ.ธนาลัย ต.เวียง อ.เมือง จ.เชียงราย 57000</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3.5">
                        ...
                        <div class="flex flex-col">
                            <span class="text-white font-medium text-xs">สถานที่ตั้งแผนก</span>
                            <span class="text-[#82889a] text-xs leading-relaxed mt-0.5">อาคารเรียน 6 ชั้น 5 แผนกวิชาเทคโนโลยีสารสนเทศ</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3.5">
                        ...
                        <div class="flex flex-col">
                            <span class="text-white font-medium text-xs">สอบถามข้อมูลเพิ่มเติม</span>
                            <a href="tel:+053713036" class="text-[#82889a] hover:text-white transition text-xs mt-0.5">053 713 036 ต่อ 109</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Copyright & Credits -->
        <div class="border-t border-gray-900 mt-6 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-[#5a5f6e] gap-4">
            <div>
                © 2026 แผนกวิชาเทคโนโลยีสารสนเทศ วิทยาลัยอาชีวศึกษาเชียงราย. All rights reserved.
            </div>
            <div class="text-[#6d7486] text-center md:text-right font-medium">
                ออกแบบและพัฒนาโดย : <span class="text-[#a0a5b5] hover:text-white transition duration-300">ครูรสธร หลวงตา</span> และ <span class="text-[#a0a5b5] hover:text-white transition duration-300">นายพัชรพล ชัยรังษี</span>
            </div>
        </div>
    </div>
</footer>
