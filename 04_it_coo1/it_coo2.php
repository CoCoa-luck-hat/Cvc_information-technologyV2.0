...
<div class="container service bg-light " style="position: relative; z-index: 9;">
    ...
    <div class="row g-3 mb-0 pt-0 rep0 repCnothave justify-content-center ">
        ...
        <div class="col-md-6 col-lg-6 col-xl-3  mb-3 portfolio-item  wow fadeInUp" data-wow-delay="0.8s">
            <div class="card">
                ...
                <div class="card-body recard-body" style="display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <p>ค่าแรกเข้า ปวช.1 = ฿4,000  </p>
                    <h1 style="color: #eb0000;">฿1,350/เทอม</h1>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-3  mb-3 portfolio-item  wow fadeInUp" data-wow-delay="0.8s">
            <div class="card">
                <div class="card-body recard-body" style="display: flex; flex-direction: column; justify-content: center;">
                    <h3 class="rehcard">ฟรีค่าเครื่องแบบนักเรียน</h3>
                    <p>
                        เงินสนับสนุนจากรัฐ
                    </p>
                    <h1 style="color: #eb0000;">฿950/เทอม</h1>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-3  mb-3 portfolio-item  wow fadeInUp" data-wow-delay="0.8s">
            <div class="card">
                <div class="card-body recard-body" style="display: flex; flex-direction: column; justify-content: center;">
                    <h3 class="rehcard">ฟรีอุปกรณ์การเรียน</h3>
                    <p>
                        เงินสนับสนุนจากรัฐ
                    </p>
                    <h1 style="color: #eb0000;">฿260/เทอม</h1>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-3  mb-3 portfolio-item  wow fadeInUp" data-wow-delay="0.8s">
            <div class="card">
                <div class="card-body recard-body" style="display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <h1 style="color: #eb0000;">฿8,000/ครั้ง</h1>
                </div>
            </div>
        </div>
    </div>
