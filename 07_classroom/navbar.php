<div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
    <div class="col-lg-6">
        <h1 class="display-6 mb-0">อาคารเรียน/ห้องเรียน เด็กไอที</h1>
    </div>
    <div class="col-lg-6 text-lg-end mt_15px">
        <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">


            </li>

            <!-- Dropdown สำหรับตัวเลือกห้องเรียน -->
            <li class="mx-3 fontt" style="margin-right: 0rem !important;">
                <div class="dropdown dropdown12">
                    <button class="dropdown-toggle dropbtn" type="button" id="dropdownMenuButton"
